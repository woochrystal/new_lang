...
/*
 * path           : app/groupware/{member}/vacation/page.jsx
 * fileName       : page.jsx
 * author         : Woo Sujeong
 * date           : 25. 08. 29.
 * description    : 기본 공통 레이아웃/컴포넌트 퍼블리싱 확인용 파일
 * ===========================================================
 * DATE              AUTHOR        NOTE
 * -----------------------------------------------------------
 * 25. 08. 29.        Woo Sujeong       최초 생성
 */
'use client';
    ...
    <>
      ...
      <Wrapper className={'pageContent'}>
        <Wrapper className={'pageScroll'}>
          <Wrapper className={'pageBasic'}>
            {/* 2 3 4의 배수 같은 크기로 가로 정렬 시 사용 */}
            <Wrapper className="hasItem03">
              {/* 셀렉트 */}
              <Select />
