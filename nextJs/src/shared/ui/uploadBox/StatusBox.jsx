// 상단 플러스아이콘, 하단 서치인풋으로 된 구조(기능은 넣은거 없음)

'use client';
import { useEffect, useState } from 'react';
import styles from '@/shared/ui/uploadBox/uploadBox.module.scss';
import inputstyles from '@/shared/ui/Input/search.module.scss';
    ...
    <div className="hasItem03">
      ...
      <div className={`${styles.uploadBox} ${styles.statusBox}`}>
        ...
        <div className={styles.uploadBoxName}>
          {/* SearchInput */}
          <div className={`${inputstyles.inputSearch} ${styles.inputSearch}`}>
            <input type="search" id={'searchInput2'} placeholder={'검색인풋'} disabled={false} />
            <button>
      ...
      <div className={`${styles.uploadBox} ${styles.statusBox}`}>
        ...
        <div className={styles.uploadBoxName}>
          {/* SearchInput */}
          <div className={`${inputstyles.inputSearch} ${styles.inputSearch}`}>
            <input type="search" id={'searchInput3'} placeholder={'검색인풋'} disabled={false} />
            <button>
              <img src="/search.png" alt="돋보기 아이콘" />
            </button>
          </div>
